...
$(function () {
    ...
    setInterval(function() {
        $.get('/backend/balance', function(data) {
            $('.activeBalance').text(data.balance + ' ' + data.currency);
        });
    }, 3000);
    ...
    $('#daterange-btn').daterangepicker(
        ...
        function (start, end) {
            ...
            $('#dates').val(start.format('YYYY-MM-DD HH:mm') + ' - ' + end.format('YYYY-MM-DD HH:mm'));
            $('#dates_view').val(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
        }
    );
